// Government sources to monitor for relocant-relevant content
// Each source defines what to crawl and how to filter
...
export interface CrawlerSource {
  ...
  name: string;
  url: string;
  rssUrl?: string;         // RSS feed if available (preferred)
  crawlSelector?: string;  // CSS selector for articles if no RSS
  language: string;        // source language
  targetLanguages: ('uk' | 'ru' | 'en')[]; // translate to these
  tags: string[];          // auto-tags for articles

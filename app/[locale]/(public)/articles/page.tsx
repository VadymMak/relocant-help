...
import { mockArticles, COUNTRY_FILTERS } from '@/lib/mock-articles'
...
export default function ArticlesPage() {
  ...
  const filtered = activeFilter === 'ALL'
    ? mockArticles
    : mockArticles.filter(a => a.country === activeFilter)
                ...
                >
                  <div style={{
                    ...
                    <h3 style={{
                      ...
                      color: 'var(--rh-fg-1)', lineHeight: 1.4,
                ...
                {Array.from({ length: totalPages }, (_, i) => i + 1).map(n => (
                  <button
                    ...
                    style={{
                      ...
                      fontFamily: 'var(--rh-font)', fontSize: 13, fontWeight: 600,
                      cursor: 'pointer',
                    }}
                  >
                    {n}
